...
(() => {
    ...
    async function init() {
        ...
        (() => {
            ...
            [['Alby', 'https://chromewebstore.google.com/detail/alby-bitcoin-lightning-wa/iokeahhehimjnekafflcihljlcjccdbe'], ['nos2x', 'https://chromewebstore.google.com/detail/nos2x/kpgefcfmnafjgpblomihpgmejjdanjjp']].forEach(([label, href]) => {
